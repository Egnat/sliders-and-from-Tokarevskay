...
let images = [{
    ...
    url:'public/images/3-fig.png',/*public/ добавляем, когда смотрим не в реакте*/
    title:'City2'
  }
  ];
...
cardOff.addEventListener('click', () => {//function show
  const photoOff = document.querySelector('.filterImgHeader');//Можно спрятать и вернуть любой элемент filterImgHeader 
